...
<tbody>
    <?php
        ...
        <tr>
            ...
            <td><span class="badge badge-warning"><?php echo $data['kategori_produk']; ?></span></td>
            <?php 
            }elseif($data['kategori_produk']== baju){ ?>
            <td><span class="badge badge-info"><?php echo $data['kategori_produk']; ?></span></td>
            <?php 
            }elseif($data['kategori_produk']== makanan){ ?>
            <td><span class="badge badge-success"><?php echo $data['kategori_produk']; ?></span></td>
            <?php 
            }elseif($data['kategori_produk']== perkakas){ ?>
            <td><span class="badge badge-danger"><?php echo $data['kategori_produk']; ?></span></td>
